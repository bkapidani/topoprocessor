...
class CSGeometry(netgen.libngpy._meshing.NetgenGeometry):
    def Add(self, solid: Solid, bcmod: list = [], maxh: typing.SupportsFloat | typing.SupportsIndex = 1e+99, col: tuple = (), transparent: bool = False, layer: typing.SupportsInt | typing.SupportsIndex = 1) -> int:
        ...
    def AddPoint(self, arg0: netgen.libngpy._meshing.Point3d, arg1: typing.SupportsInt | typing.SupportsIndex | str) -> CSGeometry:
        ...
    ...
    def CloseSurfaces(self, solid1: Solid, solid2: Solid, slices: list) -> None:
        ...
    @typing.overload
    def CloseSurfaces(self, solid1: Solid, solid2: Solid, reflevels: typing.SupportsInt | typing.SupportsIndex = 2, domain: Solid = None) -> None:
        ...
    def Draw(self) -> None:
        ...
    ...
    def GetSolids(self) -> list:
        ...
    def GetTransparent(self, tlonr: typing.SupportsInt | typing.SupportsIndex) -> bool:
        ...
    def GetVisible(self, tlonr: typing.SupportsInt | typing.SupportsIndex) -> bool:
        ...
    ...
    def SetBoundingBox(self, pmin: netgen.libngpy._meshing.Point3d, pmax: netgen.libngpy._meshing.Point3d) -> None:
        ...
    def SetTransparent(self, tlonr: typing.SupportsInt | typing.SupportsIndex, transparent: bool) -> None:
        ...
    def SetVisible(self, tlonr: typing.SupportsInt | typing.SupportsIndex, visible: bool) -> None:
        ...
    def SingularEdge(self, arg0: Solid, arg1: Solid, arg2: typing.SupportsFloat | typing.SupportsIndex) -> None:
        ...
    def SingularFace(self, solid: Solid, surfaces: Solid = None, factor: typing.SupportsFloat | typing.SupportsIndex = 0.25) -> None:
        ...
    def SingularPoint(self, arg0: Solid, arg1: Solid, arg2: Solid, arg3: typing.SupportsFloat | typing.SupportsIndex) -> None:
        ...
...
class Solid:
    ...
    def __sub__(self, arg0: Solid) -> Solid:
        ...
    @typing.overload
    def bc(self, arg0: typing.SupportsInt | typing.SupportsIndex) -> Solid:
        ...
    @typing.overload
    ...
    def mat(self) -> str:
        ...
    def maxh(self, arg0: typing.SupportsFloat | typing.SupportsIndex) -> Solid:
        ...
    def transp(self) -> Solid:
        ...
class SplineCurve2d:
    def AddPoint(self, arg0: typing.SupportsFloat | typing.SupportsIndex, arg1: typing.SupportsFloat | typing.SupportsIndex) -> int:
        ...
    @typing.overload
    def AddSegment(self, p1: typing.SupportsInt | typing.SupportsIndex, p2: typing.SupportsInt | typing.SupportsIndex, bcname: str = 'default', maxh: typing.SupportsFloat | typing.SupportsIndex = 1e+99) -> None:
        ...
    @typing.overload
    def AddSegment(self, p1: typing.SupportsInt | typing.SupportsIndex, p2: typing.SupportsInt | typing.SupportsIndex, p3: typing.SupportsInt | typing.SupportsIndex, bcname: str = 'default', maxh: typing.SupportsFloat | typing.SupportsIndex = 1e+99) -> None:
        ...
    def __init__(self) -> None:
        ...
class SplineCurve3d:
    def AddPoint(self, arg0: typing.SupportsFloat | typing.SupportsIndex, arg1: typing.SupportsFloat | typing.SupportsIndex, arg2: typing.SupportsFloat | typing.SupportsIndex) -> int:
        ...
    @typing.overload
    def AddSegment(self, arg0: typing.SupportsInt | typing.SupportsIndex, arg1: typing.SupportsInt | typing.SupportsIndex) -> None:
        ...
    @typing.overload
    def AddSegment(self, arg0: typing.SupportsInt | typing.SupportsIndex, arg1: typing.SupportsInt | typing.SupportsIndex, arg2: typing.SupportsInt | typing.SupportsIndex) -> None:
        ...
    def __init__(self) -> None:
        ...
class SplineSurface:
    ...
    """
    def AddPoint(self, x: typing.SupportsFloat | typing.SupportsIndex, y: typing.SupportsFloat | typing.SupportsIndex, z: typing.SupportsFloat | typing.SupportsIndex, hpref: bool = False) -> int:
        ...
    @typing.overload
    def AddSegment(self, pnt1: typing.SupportsInt | typing.SupportsIndex, pnt2: typing.SupportsInt | typing.SupportsIndex, bcname: str = 'default', maxh: typing.SupportsFloat | typing.SupportsIndex = -1.0) -> None:
        ...
    @typing.overload
    def AddSegment(self, pnt1: typing.SupportsInt | typing.SupportsIndex, pnt2: typing.SupportsInt | typing.SupportsIndex, pnt3: typing.SupportsInt | typing.SupportsIndex, bcname: str = 'default', maxh: typing.SupportsFloat | typing.SupportsIndex = -1.0) -> None:
        ...
    def __init__(self, base: SPSolid, cuts: list = []) -> None:
        ...
def And(arg0: Solid, arg1: Solid) -> Solid:
    ...
def Cone(arg0: netgen.libngpy._meshing.Point3d, arg1: netgen.libngpy._meshing.Point3d, arg2: typing.SupportsFloat | typing.SupportsIndex, arg3: typing.SupportsFloat | typing.SupportsIndex) -> Solid:
    ...
def Cylinder(arg0: netgen.libngpy._meshing.Point3d, arg1: netgen.libngpy._meshing.Point3d, arg2: typing.SupportsFloat | typing.SupportsIndex) -> Solid:
    ...
def Ellipsoid(arg0: netgen.libngpy._meshing.Point3d, arg1: netgen.libngpy._meshing.Vec3d, arg2: netgen.libngpy._meshing.Vec3d, arg3: netgen.libngpy._meshing.Vec3d) -> Solid:
    ...
def EllipticCone(a: netgen.libngpy._meshing.Point3d, vl: netgen.libngpy._meshing.Vec3d, vs: netgen.libngpy._meshing.Vec3d, h: typing.SupportsFloat | typing.SupportsIndex, r: typing.SupportsFloat | typing.SupportsIndex) -> Solid:
    """
...
def Save(arg0: netgen.libngpy._meshing.Mesh, arg1: str, arg2: CSGeometry) -> None:
    ...
def Sphere(arg0: netgen.libngpy._meshing.Point3d, arg1: typing.SupportsFloat | typing.SupportsIndex) -> Solid:
    ...
def Torus(arg0: netgen.libngpy._meshing.Point3d, arg1: netgen.libngpy._meshing.Vec3d, arg2: typing.SupportsFloat | typing.SupportsIndex, arg3: typing.SupportsFloat | typing.SupportsIndex) -> Solid:
    ...
