...
class STLGeometry(netgen.libngpy._meshing.NetgenGeometry):
    ...
    def GetDirtyTrigs(self, **kwargs) -> None:
        ...
    def GetVicinity(self, node: typing.SupportsInt | typing.SupportsIndex, size: typing.SupportsInt | typing.SupportsIndex, node_type: str = 'trig') -> STLGeometry:
        ...
    def MovePointToMiddle(self, arg0: typing.SupportsInt | typing.SupportsIndex, arg1: typing.SupportsInt | typing.SupportsIndex) -> None:
        ...
